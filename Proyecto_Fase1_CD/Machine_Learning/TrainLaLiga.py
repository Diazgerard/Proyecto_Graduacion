...
Script de entrenamiento para modelos de predicción de la La Liga.
Entrena modelos XGBoost y Poisson, guarda archivos .pkl.

Uso: python TrainLaLiga.py
"""
...
# Configuración
DATA_PATH = "../Data_Mining/eda_outputsMatchesLaLiga/match_data_cleaned.csv"
MODELS_DIR = "models/laliga/"
RANDOM_STATE = 42
...
def train_models():
    ...
    print("="*60)
    print("ENTRENAMIENTO DE MODELOS - LA LIGA")
    print("="*60)
    ...
    print(f"\nPara hacer predicciones, ejecuta: python PredictionLaLiga.py")
