...
Script independiente para predicción de partidos de La Liga.
Genera features dinámicas actualizadas para cada predicción.

Uso: python PredictionLaLiga.py
"""
...
class LaLigaPredictor:
    """
    Predictor de partidos de La Liga usando modelos entrenados.
    Genera features dinámicas en tiempo real para predicciones precisas.
    """
    
    def __init__(self, models_path="models/laliga/", data_path="../Data_Mining/eda_outputsMatchesLaLiga/match_data_cleaned.csv"):
    ...
    def load_models(self):
        ...
        try:
            print("Cargando modelos de La Liga...")
...
if __name__ == "__main__":
    print("=== PREDICTOR DE PARTIDOS LA LIGA ===")
    ...
    if not predictor.load_models():
        ...
        print("Ejecuta el script de entrenamiento primero: python TrainLaLiga.py")
        exit()
