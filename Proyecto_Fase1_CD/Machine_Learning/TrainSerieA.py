...
Script de entrenamiento para modelos de predicción de la Serie A.
Entrena modelos XGBoost y Poisson, guarda archivos .pkl.

Uso: python TrainSerieA.py
"""
...
# Configuración
DATA_PATH = "../Data_Mining/eda_outputsMatchesSerieA/match_data_cleaned.csv"
MODELS_DIR = "models/seriea/"
RANDOM_STATE = 42
...
def train_models():
    ...
    print("="*60)
    print("ENTRENAMIENTO DE MODELOS - SERIE A")
    print("="*60)
    ...
    print(f"\nPara hacer predicciones, ejecuta: python PredictionSerieA.py")
