...
Script independiente para predicción de partidos de la Bundesliga.
...
class BundesligaPredictor:
    """
    Predictor de partidos de la Bundesliga usando modelos entrenados.
    Genera features dinámicas en tiempo real para predicciones precisas.
    """
    
    def __init__(self, models_path="models/bundesliga/", data_path="../Data_Mining/eda_outputsMatchesBundesliga/match_data_cleaned.csv"):
    ...
    def load_models(self):
        ...
        try:
            print("Cargando modelos de la Bundesliga...")
...
if __name__ == "__main__":
    print("=== PREDICTOR DE PARTIDOS BUNDESLIGA ===")
    ...
    if not predictor.load_models():
        ...
        print("Ejecuta el script de entrenamiento primero: python TrainBundesliga.py")
        exit()
