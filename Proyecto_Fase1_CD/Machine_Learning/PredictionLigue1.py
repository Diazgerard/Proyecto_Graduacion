...
Script independiente para predicción de partidos de la Ligue 1.
Genera features dinámicas actualizadas para cada predicción.

Uso: python PredictionLigue1.py
"""
...
class Ligue1Predictor:
    """
    Predictor de partidos de la Ligue 1 usando modelos entrenados.
    Genera features dinámicas en tiempo real para predicciones precisas.
    """
    
    def __init__(self, models_path="models/ligue1/", data_path="../Data_Mining/eda_outputsMatchesLigue1/match_data_cleaned.csv"):
    ...
    def load_models(self):
        ...
        try:
            print("Cargando modelos de la Ligue 1...")
...
if __name__ == "__main__":
    print("=== PREDICTOR DE PARTIDOS LIGUE 1 ===")
    ...
    if not predictor.load_models():
        ...
        print("Ejecuta el script de entrenamiento primero: python TrainLigue1.py")
        exit()
