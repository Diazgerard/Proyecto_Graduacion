...
Script independiente para predicción de partidos de la Serie A.
Genera features dinámicas actualizadas para cada predicción.

Uso: python PredictionSerieA.py
"""
...
class SerieAPredictor:
    """
    Predictor de partidos de la Serie A usando modelos entrenados.
    Genera features dinámicas en tiempo real para predicciones precisas.
    """
    
    def __init__(self, models_path="models/seriea/", data_path="../Data_Mining/eda_outputsMatchesSerieA/match_data_cleaned.csv"):
    ...
    def load_models(self):
        ...
        try:
            print("Cargando modelos de la Serie A...")
...
if __name__ == "__main__":
    print("=== PREDICTOR DE PARTIDOS SERIE A ===")
    ...
    if not predictor.load_models():
        ...
        print("Ejecuta el script de entrenamiento primero: python TrainSerieA.py")
        exit()
