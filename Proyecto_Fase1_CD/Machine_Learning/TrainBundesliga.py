...
Script de entrenamiento para modelos de predicción de la Bundesliga.
Entrena modelos XGBoost y Poisson, guarda archivos .pkl.

Uso: python TrainBundesliga.py
"""
...
def train_models():
    ...
    print("="*60)
    print("ENTRENAMIENTO DE MODELOS - BUNDESLIGA")
    print("="*60)
    ...
    print(f"\nPara hacer predicciones, ejecuta: python PredictionBundesliga.py")
